   ...
   <div class="content">
      ...
      <body>
         ...
         <div <?php include("class5.php") ?>>
            <h2 style="text-align: center; color: red;"><?php echo $newerror->get_name(); ?></h2> <!--prints maintenance error, kept in class which allows for easy customization of message delivered. Could even be controlled backend -->
         </div>
         <div id="push">&nbsp;</div>
         <!--pushes footer down-->
      </body>
      <div class="footer">        <!----Origional html footer -->
         <br>
         <br>
